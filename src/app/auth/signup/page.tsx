...
const SignUpPage = () => {
    ...
    return (
        <div className="flex h-screen w-[1440px]">
            {/* Left Section */}
            <div className="w-[932px] h-full bg-gray-200 flex items-center justify-center relative">
            ...
            <div className="w-[508px] flex flex-col justify-center items-center bg-[rgba(240, 240, 240, 1)]">
                <div className="w-full max-w-md flex flex-col px-[30px]">
                    <h1 className="text-[16px] font-bold mb-2 text-gray-800">
                        Welcome!
                    </h1>
                    <h2 className="text-[42px] font-[700] text-500 text-[#BF0401] font-semibold mb-2">Sign Up</h2>
                    ...
                    <form>
                        ...
                        <div className='text-[12px] leading-[15.12px]'>
                            The Provisions of the law requires us to obtain consent to process the data you provide us.
                            ...
                            <a href="#" className="text-red-500 hover:underline">
                                Terms of Use
                            </a> and give your consent to proceed
                        </div>

                        <div className="flex items-start mb-9 mt-5">
                            <input
                                type="checkbox"
                                id="consent"
                                name="consent"
                    ...
                    <p className="text-sm text-gray-600 mt-6">
                        Click <a href="/login" className="text-[#BF0401] font-medium hover:underline"> here</a> to Login if you already have an account{" "}
                    </p>
                </div>
            </div>
        </div>
